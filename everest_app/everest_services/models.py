...
class Service(models.Model):
    ...
    cover_image_path = models.ImageField(upload_to = 'services', blank=True)
    thumb_image_path = models.ImageField(upload_to = 'services/thumbs', blank=True)
    pricing_image_path = models.ImageField(upload_to = 'services/pricing', blank=True)
