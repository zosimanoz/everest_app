...
class Order(models.Model):
    ...
    service_type_id = models.CharField(max_length=50, blank=True)
    service_type_name = models.CharField(max_length=50 , blank=True)
    service_category_id = models.CharField(max_length=50, blank=True)
    ...
    cover_image = models.ImageField(upload_to='orders/%Y%H:%M:%S', blank=True, null=True)
