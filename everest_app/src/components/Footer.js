...
const Footer = ({ settings }) => {
    ...
    // const mainjsInstance = useRef(null);
    ...
    useEffect(() => {
        if (settings) {
            ...
            // const elem_mainjs = document.createElement('script');
            // elem_mainjs.src = '/assets/js/main.js';
            // mainjsInstance.current.appendChild(elem_mainjs);
        }
                ...
                <div className="container d-md-flex py-4">
                    ...
                    <div className="mr-md-auto text-center text-md-left">
                        ...
                        <div className="credits">
                            Designed by <a href="/">Everest Services</a>
                        </div>
                    </div>
